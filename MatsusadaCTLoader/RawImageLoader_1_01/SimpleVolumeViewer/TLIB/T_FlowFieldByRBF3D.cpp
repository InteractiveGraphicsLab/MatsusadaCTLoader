...
void T_FlowFieldByRBF3D::updateRBFWeight()
{
	...
	//solve for X Y Z Dir///////////////////////////////////////////////////
	takapack_CG_dense_solve( m_N + 1, A, m_X_b, m_X_lambda_abc);
	takapack_CG_dense_solve( m_N + 1, A, m_Y_b, m_Y_lambda_abc);
	takapack_CG_dense_solve( m_N + 1, A, m_Z_b, m_Z_lambda_abc);
