================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: SimpleVolumeViewer プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した SimpleVolumeViewer には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには SimpleVolumeViewer アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

SimpleVolumeViewer.vcproj
...
SimpleVolumeViewer.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   CSimpleVolumeViewerApp アプリケーション クラスを宣言します。

SimpleVolumeViewer.cpp
   これは、アプリケーション クラス CSimpleVolumeViewerApp を含むメイン アプリケー
   ション ソース ファイルです。

SimpleVolumeViewer.rc
...
res\SimpleVolumeViewer.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル SimpleVolumeViewer.rc に含まれていま
   す。

res\SimpleVolumeViewer.rc2
...
SimpleVolumeViewerDlg.h, SimpleVolumeViewerDlg.cpp - ダイアログ
   これらのファイルは CSimpleVolumeViewerDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な SimpleVolumeViewer.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   SimpleVolumeViewer.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
